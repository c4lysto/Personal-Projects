...
GLOBALCONST Vec4V g_IdentityX4V = Vec4V(INIT_X_AXIS);
GLOBALCONST Vec4V g_IdentityY4V = Vec4V(INIT_Y_AXIS);
GLOBALCONST Vec4V g_IdentityZ4V = Vec4V(INIT_Z_AXIS);
GLOBALCONST Vec4V g_IdentityW4V = Vec4V(INIT_W_AXIS);
GLOBALCONST Vec4V g_WorldUp4V	= Vec4V(INIT_UP_AXIS);
