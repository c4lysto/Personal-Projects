...
GLOBALCONST Vec3V g_IdentityX3V = Vec3V(INIT_X_AXIS);
GLOBALCONST Vec3V g_IdentityY3V = Vec3V(INIT_Y_AXIS);
GLOBALCONST Vec3V g_IdentityZ3V = Vec3V(INIT_Z_AXIS);
GLOBALCONST Vec3V g_IdentityW3V	= Vec3V(INIT_ZERO);
GLOBALCONST Vec3V g_WorldUp3V	= Vec3V(INIT_UP_AXIS);
