...
public:
	ILight() : m_vColor(1.0f, 1.0f, 1.0f), m_fSpecularPower(0.0f), m_fSpecularIntensity(1.0f) {}
	virtual ~ILight() = 0 {}
	...
	float GetSpecularIntensity() const {return m_fSpecularIntensity;}
	...
	void SetSpecularIntensity(float fSpecularIntensity) {m_fSpecularIntensity = fSpecularIntensity;}
